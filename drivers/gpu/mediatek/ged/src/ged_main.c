...
static const struct proc_ops ged_fops = {
        ...
        .proc_poll           = ged_poll,          // Вернули poll
        .proc_read           = ged_read,          // Вернули read
        .proc_write          = ged_write,         // Вернули write
        .proc_ioctl          = ged_ioctl,
#ifdef CONFIG_COMPAT
        .proc_compat_ioctl   = ged_ioctl_compat,  // Исправили имя функции на оригинал
#endif
};
/******************************************************************************
 * GED File operations
