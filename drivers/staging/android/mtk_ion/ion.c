...
static const struct proc_ops proc_client_fops = {
	.proc_open = ion_proc_client_open,
	.proc_read = seq_read,
...
static void *__maybe_unused ion_dma_buf_kmap(struct dma_buf *dmabuf, unsigned long offset)
{
	struct ion_buffer *buffer = dmabuf->priv;
	void *vaddr;
...
static void __maybe_unused ion_dma_buf_kunmap(struct dma_buf *dmabuf, unsigned long offset,
			       void *ptr)
{
	struct ion_buffer *buffer = dmabuf->priv;
...
static const struct proc_ops proc_shrink_fops = {	.proc_open = proc_shrink_fops_open,
