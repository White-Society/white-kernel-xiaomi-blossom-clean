...
#endif
/* end CONFIG_COMPAT */
static const struct file_operations fbconfig_file_fops = {
    .read = fbconfig_read,
...
static const struct proc_ops fbconfig_fops = {
    .proc_read = fbconfig_read,
    .proc_write = fbconfig_write,
    .proc_open = fbconfig_open,
    .proc_ioctl = fbconfig_ioctl,
#ifdef CONFIG_COMPAT
    .proc_compat_ioctl = compat_fbconfig_ioctl,
#endif
    .proc_release = fbconfig_release,
};
...
void PanelMaster_Init(void)
{
	...
	ConfigPara_dbgfs = debugfs_create_file("fbconfig", S_IFREG | 0444,
				NULL, (void *)0, &fbconfig_file_fops);
