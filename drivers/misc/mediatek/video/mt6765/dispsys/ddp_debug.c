...
static const struct proc_ops low_power_cust_proc_fops = {
	.proc_read	= lp_cust_read,
};

static const struct proc_ops debug_fops_dump_proc = {
	.proc_read	= debug_dump_read,
};
